...
<head>
    ...
    <style>
        ...
        .price-slider-container input[type="range"] {
            width: calc(100% - 80px); /* Adjust width to accommodate for input field */
...
<body>
    <div class="container">
        ...
        <div>
            ...
            <div class="category-buttons">
                <input type="checkbox" id="fast-food" onclick="filterCategory(this)" checked> Fast Food
                <input type="checkbox" id="drinks" onclick="filterCategory(this)" checked> Drinks
                <input type="checkbox" id="combo" onclick="filterCategory(this)" checked> Combo
                <input type="checkbox" id="others" onclick="filterCategory(this)" checked> Others
            </div>
            <div class="availability-buttons">
                <input type="checkbox" id="available-now" onclick="filterAvailability()" checked> Available Now
                <input type="checkbox" id="not-available-now" onclick="filterAvailability()" checked> Not Available Now
            </div>
            <table>
                <thead>
                    <tr>
    ...
    <script>
        ...
        function updatePriceSliderValue() {
            var sliderValue = document.getElementById('price-slider').value;
