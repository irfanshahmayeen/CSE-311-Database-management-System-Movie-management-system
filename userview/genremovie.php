...
<div class="container">
    ...
    // Check if genre_name is set
    if (isset($_GET['genre_name'])) {
        $genre_name = $conn->real_escape_string($_GET['genre_name']);
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>No movies found for genre: " . htmlspecialchars($genre_name) . ".</p>";
        }
    } else {
        echo "<p>No genre specified.</p>";
    }
