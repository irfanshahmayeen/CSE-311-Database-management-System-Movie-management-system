...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<button class='delete-btn' onclick='window.location.href=\"producerDelete.php?ProducrID=" . $row["ProducerID"] . "\"'>Delete</button>";
        echo "<button class='update-btn' onclick='window.location.href=\"producerUpdate.php?ProducerID=" . $row["ProducerID"] . "\"'>Update</button>";
        echo "</td>";
        echo "</tr>";
    }
} else {
