...
<body>
   <?php
          echo "<h1>Cast Work</h1>";
          $CastID = $_GET['CastID'];
      
          $cast_find = "SELECT * FROM casts WHERE CastID ='$CastID'";
          $result = $conn->query($cast_find);
...
$sql = "SELECT *
FROM movie
JOIN castWork ON castWork.MovieID = movie.MovieID

WHERE castWork.CastID = '$CastID'" ;
